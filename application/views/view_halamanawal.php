...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url("assets/landingpage/css/styles.css")?>" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Pengaduan Masyarakat</a><button class="navbar-toggler navbar-toggler-right text-uppercase font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu <i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Portfolio</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">Tentang Kami</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <h1 class="masthead-heading text-uppercase mb-0">Layanan Masyarakat</h1>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="<?php echo base_url("assets/landingpage/img/portfolio/pengaduan.png")?>" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="<?php echo base_url("assets/landingpage/img/portfolio/download.jpg")?>" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="<?php echo base_url("assets/landingpage/img/portfolio/surat.jpg")?>" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 4-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Layanan pengaduan masyarakat adalah salah satu bentuk partisipasi untuk ikut berperan dalam membangun dan pengawasan terhadap kinerja instansi pemerintah. Dengan demikian dibutuhkan adanya sebuah rancangan aplikasi layanan informasi pengaduan untuk memudahkan masyarakat dalam menyampaikan keluhan dan aspirasinya.</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">Disini masyarakat dapat melaporkan beberapa masalah yang terjadi di lingkungan sekitar.</p></div>
                </div>
        ...
        <!-- Contact form JS-->
        <script src="<?php echo base_url("assets/landingpage/mail/jqBootstrapValidation.js")?>"></script>
        <script src="<?php echo base_url("assets/landingpage/mail/contact_me.js")?>"></script>
        <!-- Core theme JS-->
        <script src="<?php echo base_url("assets/landingpage/js/scripts.js")?>"></script>
    </body>
</html>
